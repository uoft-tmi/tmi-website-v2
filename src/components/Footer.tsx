...
export default function Footer() {
    ...
    const socialLinks = [
        {
            name: "Discord",
            href: "https://discord.gg/9p7dP3WsGG",
            icon: (
                <svg
                    className="w-6 h-6"
                    fill="currentColor"
        ...
        {
            name: "Instagram",
            href: "https://www.instagram.com/uoft_tmi/",
            icon: (
                <svg
                    className="w-6 h-6"
                    fill="currentColor"
        ...
        {
            name: "Email",
            href: "mmailto:utoronto.tmi@gmail.com",
            icon: (
                <svg
                    className="w-6 h-6"
                    fill="none"
    ...
    return (
        <footer className="w-full bg-card border-t border-secondary/20 mt-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-2">
                        ...
                        <p className="text-sm text-text-muted text-center md:text-left">
                            © {currentYear} TMI. All rights reserved.
                        </p>
                    </div>
